...
* Posts buffers and line-ranges to [hpaste.org](http://hpaste.org). **Note:** hpaste doesn't seem to exist anymore, this functionality will probably be altered or removed
